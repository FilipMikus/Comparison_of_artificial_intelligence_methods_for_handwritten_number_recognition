...
class DatasetConverter:
    ...
    def ardis_to_yolov5(source_train_data_ardis_path, source_val_data_ardis_path, source_train_labels_ardis_path,
        ...
        ardis_train_labels_df = pd.read_csv(source_train_labels_ardis_path, sep="         ", header=None,
                                            engine="python")
...
if __name__ == '__main__':
    DatasetConverter.mnist_to_coco()
    DatasetConverter.ardis_to_coco()
    DatasetConverter.ardis_to_yolov5()
